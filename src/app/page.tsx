...
export default function Home() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* ── Hero ──────────────────────────────────────────────────────── */}
        <section className="mx-auto max-w-5xl px-6 pb-20 pt-24 text-center lg:pt-32">
          ...
          <h1 className="animate-fade-up stagger-1 font-display text-5xl font-800 leading-[1.08] tracking-tight text-foreground sm:text-6xl lg:text-[4.5rem]">
            Your whole career,
            <br />
            <span className="text-primary">one profile.</span>
          </h1>

          <p className="animate-fade-up stagger-2 mx-auto mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
          ...
          <div className="animate-fade-up stagger-3 mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Button size="lg" className="h-11 gap-2 px-6 font-semibold text-base">
              Start for free
        ...
        <section className="mx-auto max-w-5xl px-6 py-20 lg:py-28">
          <div className="mb-14 text-center">
            <h2 className="animate-fade-up font-display text-3xl font-700 tracking-tight text-foreground sm:text-4xl">
              Everything you need, nothing you don&apos;t
            </h2>
            <p className="animate-fade-up stagger-1 mt-3 text-muted-foreground max-w-lg mx-auto">
        ...
        <section className="mx-auto max-w-5xl px-6 py-20 lg:py-28">
          <div className="mb-14 text-center">
            ...
            <p className="animate-fade-up stagger-1 mt-3 text-muted-foreground max-w-md mx-auto">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {steps.map((step, i) => (
              ...
              >
                <div className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-primary/20 bg-secondary text-sm font-bold font-display text-primary">
                  {step.number}
                </div>
                <div>
          ...
          <Card className="animate-fade-up border-primary/10 bg-secondary/40 shadow-none">
            <CardContent className="flex flex-col items-center gap-8 py-14 text-center md:flex-row md:items-start md:text-left md:py-12 md:px-14">
              <div className="flex-1">
                <h2 className="font-display text-2xl font-700 tracking-tight text-foreground sm:text-3xl mb-3">
              ...
              <div className="flex flex-col items-center gap-3 md:items-start md:justify-center md:pt-2 shrink-0">
                <Button size="lg" className="h-11 gap-2 px-6 font-semibold text-base w-full md:w-auto">
                  Get started free
                  <ArrowRight className="size-4" />
                </Button>
        ...
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-7">
          <div className="flex items-center gap-2">
            <div className="flex h-6 w-6 items-center justify-center rounded-md bg-primary">
              <span className="font-display text-xs font-bold text-primary-foreground leading-none">
                U
              </span>
            </div>
